...
## Environments
- Preview: https://main--commerce-edge-v2--manuelmattar.aem.page/
- Live: https://main--commerce-edge-v2--manuelmattar.aem.live/
...
1. Open the `commerce-edge-v2` directory in your favourite IDE and start coding :)
